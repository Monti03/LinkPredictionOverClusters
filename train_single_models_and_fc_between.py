...
from utils.utils import convert_sparse_matrix_to_sparse_tensor, compute_adj_norm, plot_cf_matrix, plot, get_test_valid_false_edges, get_edges_formatted

from trainers.OnePerClustTrainer import OnePerClustTrainer
...
if __name__ == "__main__":
    ...
    trainer = OnePerClustTrainer(False, "OnePerClusterWithFc", BATCH_SIZE, PATIENCE, EPOCHS, LR, N_CLUSTERS, DATASET_NAME)
